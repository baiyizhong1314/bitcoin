 ...
 * the next 2048 blocks (roughly 2 weeks), nor is it permitted to activate a feature further out than
 * 12288 blocks (roughly 12 weeks) to ensure sufficient notice.
 *
 * This does not apply for activation during initialization, and may not apply for test networks.
 */
