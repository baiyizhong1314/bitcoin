...
[![Build Status](https://travis-ci.org/dexX7/bitcoin.svg?branch=addrindex-omnicore-0.0.12)](https://travis-ci.org/dexX7/bitcoin)

Modifications
-------------

This branch is based [Omni Core v0.0.12](https://github.com/OmniLayer/omnicore/releases/tag/v0.0.12) ([diff](https://github.com/OmniLayer/omnicore/compare/v0.0.12...dexX7:addrindex-omnicore-0.0.12)) and includes the required changes to allow extended transaction lookups based on an address.
