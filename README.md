...
This branch is based [Omni Core v0.0.11](https://github.com/OmniLayer/omnicore/releases/tag/v0.0.11) ([diff](https://github.com/OmniLayer/omnicore/compare/v0.0.11...dexX7:addrindex-omnicore-0.0.11)) and includes the required changes to allow extended transaction lookups based on an address.
