...
This branch is based on the [0.9](https://github.com/bitcoin/bitcoin/tree/0.9) ([diff](https://github.com/bitcoin/bitcoin/compare/0.9...dexX7:addrindex-0.9)) branch of Bitcoin Core and includes the required changes to allow extended transaction lookups based on an address.
